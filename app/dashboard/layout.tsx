...
export default function DashboardLayout({
    ...
    return (
        <div className="min-h-screen relative font-sans text-neutral-200">
            ...
            />
            {/* Dark Overlay Gradient - slightly lighter as requested */}
                ...
                <nav className="border-b border-white/5 bg-neutral-950/40 backdrop-blur-md sticky top-0 z-50">
                    <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded bg-red-900 flex items-center justify-center font-serif font-bold text-white border border-red-800 shadow-[0_0_15px_rgba(158,27,50,0.5)]">
                                L
                            </div>
